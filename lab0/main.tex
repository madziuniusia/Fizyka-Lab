...
\vspace{1em}
Po podniesieniu równania na kwadrat otrzymujemy postać liniową:
\[
  T^2 = \frac{4\pi^2}{g}\,l,
\]
...
experimentalne wyznaczenie wartości \(g\).
...
odpowiednio poziomom ufności około \(95\,\%\) i \(99.7\,\%\).
...
\end{equation}
co odpowiada przedziałowi ufności na poziomie ok.~95 \%.
...
\[
  T^2 = (4{,}02 \pm 0{,}05)\,l - (0{,}0475 \pm 0{,}005),
\]
...
\[
  g = \frac{4\pi^2}{a}
  = \frac{4\pi^2}{4{,}02}
  = \SI{9,82}{\meter\per\second\squared}.
\]
...
co świadczy o poprawnym wykonaniu pomiarów i niskim poziomie błędów
systematycznych.
Główne źródła niepewności to dokładność wyznaczenia długości
wahadła oraz reakcja operatora przy pomiarach czasu.
Metoda linearyzacji okazała się znacznie bardziej stabilna
i wiarygodna niż pojedyncze wyznaczenie \(g\)
dla jednej ustalonej długości.
...
dopasowania. Dzięki liniowej analizie zależności \(T^2(l)\)
niepewność wyniku wyznaczenia \(g\) uległa zmniejszeniu
w porównaniu z pomiarem jednostkowym.
