...
\]
Średnia wartość stałej halotronu wyniosła:
\[
  \boxed{c_{\mathrm{avg}} = 95{,}2\ \mathrm{V/(A\cdot T)}}.
\]
...
Otrzymane wartości \(c\) mieszczą się w typowym zakresie
dla czujników półprzewodnikowych, co potwierdza poprawność
przeprowadzonego cechowania.
\section{Wnioski}
